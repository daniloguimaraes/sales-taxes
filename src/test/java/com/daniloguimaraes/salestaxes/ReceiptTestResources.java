...
public class ReceiptTestResources {
    ...
    protected static String naturalLanguageReceipt3;
    ...
    public static void loadReceiptFiles() throws Exception {
        ...
        naturalLanguageReceipt3 = FileUtils.readFileToString(
                new File("src/test/resources/receipt/txt/receipt3.txt"), UTF_8);
